...
description: "Learn how to instantiate TFT_eSPI, initialize your display with init() or begin(), configure rotation modes 0–3, and master the pixel coordinate system."
---
